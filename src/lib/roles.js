export const LEGACY_SPECIALIST_ROLES = [
  "researcher",
...
export const ALLOWED_HIGH_ROLES = [
  "planner-high",
  "researcher-high",
  "devil-advocate-high",
  "legal-reviewer-high",
...
export const ROLE_REGISTRY = [
  {
    ...
    effort: "medium",
    sourceRole: "ceo",
    description: "사용자 요청을 mission/job으로 분해하고 role / tier를 밝히며 보고하는 오케스트레이터",
  },
  {
    name: "god",
    kind: "control",
    ...
    effort: "medium",
    sourceRole: "god",
    description: "관리자 전용 운영자. 공개 ingress가 아니라 recovery와 override를 담당",
  },
  {
    name: "explore-low",
    kind: "utility",
  ...
  },
  {
    ...
    effort: "high",
    sourceRole: "ceo",
    description: "고난도 설계 판단, 구조 분해, 리스크가 큰 architecture work 전용",
  },
  {
  ...
  ...LEGACY_SPECIALIST_ROLES.map((name) => ({
    name,
    kind: "specialist",
